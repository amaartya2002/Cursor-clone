...
![nav-bar](./layouts-screenshots/cursor-navbar.png)

- Hero Section

![hero-section](./layouts-screenshots/cursor-heroSection.png)

- Trusted By / Company Logos

![trusted-by](./layouts-screenshots/cursor-trustedBy.png)

- Feature Sections

![features-section](./layouts-screenshots/cursor-features.png)

- Features Card Section with text and image in one card

![features-card](./layouts-screenshots/cursor-features-cards.png)

- Changelog / Updates

![change-logs](./layouts-screenshots/cursor-changelogs.png)

- Team / About Section

![team-section](./layouts-screenshots/cursor-teams.png)

- Final CTA

![final-cta](./layouts-screenshots/cursor-finalCta.png)

- Footer

![footer](./layouts-screenshots/cursor-footer.png)
